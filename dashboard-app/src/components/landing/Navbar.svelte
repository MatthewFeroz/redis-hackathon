<script lang="ts">
	import BrandLogo from '../branding/BrandLogo.svelte';
	...
	<div class="max-w-7xl mx-auto px-5 sm:px-8">
		<div class="flex items-center justify-between h-16 sm:h-20">
			...
			<a href="/" class="flex items-center gap-3 group">
				<BrandLogo markClass="w-10 h-10 transition-transform duration-300 group-hover:scale-[1.04]" textClass="text-lg" />
			</a>
